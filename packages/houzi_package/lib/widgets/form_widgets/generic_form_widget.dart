                ...
                if (showFormSectionFieldItem(formSectionField)) {
                  return Card(
                    child: Column(
                      children: [
                        /// Section Header:
                        if(formSectionField.section != null && formSectionField.section!.isNotEmpty) HeaderWidget(
                        ...
                        /// Fields:
                        if(formSectionField.fields != null && formSectionField.fields!.isNotEmpty) Padding(
                          padding: const EdgeInsets.only(top: 10, bottom: 30),
                          child: Column(
                            children: formSectionField.fields!.map((houziFormItem) {
                              if (showFormItem(houziFormItem)) {
                                String? type = houziFormItem.sectionType;
                                switch (type) {
                                  case formTextField: {
